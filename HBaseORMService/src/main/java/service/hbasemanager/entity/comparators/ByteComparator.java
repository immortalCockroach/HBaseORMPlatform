...
public class ByteComparator extends ByteArrayComparable {
     ...
     */
    boolean areSerializedFieldsEqual(ByteComparator other) {
        if (other == this) return true;
        if (!(other instanceof ByteComparator)) return false;
